describe("ViewManager: 클릭 이벤트 처리 및 뷰를 담당하는 함수입니다.", () => {
  it("viewManager에 textManager가 잘 전달되는지 확인", () => {
  ...
  it("viewManager에 필요한 요소 세가지가 잘 전달되는지 확인", () => {
  ...
  it("click 이벤트가 발생했을 때 changeValue 함수가 호출되는지 확인", () => {
    // 특정 객체의 함수를 감시
  ...
  it("changeValue 함수가 호출됐을 때 updateView 함수가 호출되는지 확인", () => {
